...
class KsSyncProgramCreativeReportCommand extends BaseCommand
{
    /**
     * 命令行执行命令
     * @var string
     */
    protected $signature = 'ks:sync_program_creative_report  {--date=} {--account_ids=} {--delete=} {--running=} {--multi_chunk_size=} {--key_suffix=} {--run_by_account_charge=}';
     ...
     * @var string
     */
    protected $description = '同步快手程序化创意报表';
    ...
    public function handle(){
        ...
        // 锁 key
        $lockKey = 'ks_sync_program_creative_report';
