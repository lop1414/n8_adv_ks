...
-- ----------------------------
-- Table structure for ks_material_program_creatives
-- ----------------------------
DROP TABLE IF EXISTS `ks_material_program_creatives`;
CREATE TABLE `ks_material_program_creatives` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='快手素材-程序化创意关联表表';
