...
Date: 2021-06-17 14:31:12
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for task_ks_syncs
-- ----------------------------
DROP TABLE IF EXISTS `task_ks_syncs`;
CREATE TABLE `task_ks_syncs` (
...
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8 COMMENT='快手同步任务表';
